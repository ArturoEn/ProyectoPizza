...
public class Registro extends javax.swing.JFrame {
    ...
    public void  AgregarUsuario(){
        ...
        String nom = String.valueOf(CajaNombre.getText());
        String apell = String.valueOf(CajaApellido.getText());
        String direccion = String.valueOf(CajaDire.getText());
        
        
        try {
           String sql = "insert into usuario (nombre,apellidos,direccion,usuarios,pass) values ('"+nom+"','"+apell+"','"+direccion+"','"+user+"','"+passw+"')";
                    con = con1.getConnection();
                    st = con.createStatement();
                    st.executeUpdate(sql);
                    JOptionPane.showMessageDialog(null, "Registrado");
        } catch (Exception e){
             JOptionPane.showMessageDialog(null, "No se pudo regsitar existe un error" + "en" + e.getMessage());
        }
    }
    ...
    private void initComponents() {
        ...
        CajaDire = new javax.swing.JTextField();
        ...
        jLabel6.setText("Crea un nombre de usuario y una contraseña.");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(CajaDire, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(10, 10, 10)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(CajaApellido, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(121, 121, 121)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(10, 10, 10)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(CajaDire, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private javax.swing.JTextField CajaDire;
